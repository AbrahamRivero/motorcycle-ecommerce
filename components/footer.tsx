...
const Footer = () => {
  ...
  return (
    <footer className="pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32 bg-[#111212]">
      <div className="mx-auto container px-4 w-full">
          ...
          <div>
            ...
            <div className="mt-6 space-y-4">
              <div className="flex items-center">
                <div className="p-1 rounded-full bg-slate-600 mr-2">
                  <MapPinIcon className="w-5 h-5 text-white" />
                </div>
                <span className="text-sm/6 text-gray-400 hover:text-white">
                  23 Relevation Street <br /> Paris France
                </span>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                <div className="p-1.5 rounded-full bg-slate-600 mr-2">
                  <MailIcon className="w-[17px] h-[17px] text-white" />
                </div>
                <a
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
          ...
          <p className="mt-8 text-sm/6 text-gray-400 md:order-1 md:mt-0">
            Copyright &copy; {new Date().getFullYear()} Bike, Inc. All rights
            reserved.
          </p>
        </div>
      </div>
