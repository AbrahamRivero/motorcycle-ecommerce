    ...
    <div className="bg-background">
      <div className="relative isolate overflow-hidden pt-14">
        <img
          ...
          src="https://images.unsplash.com/photo-1558981285-6f0c94958bb6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2830&q=80&blend=2A2D3E&sat=-100&exp=15&blend-mode=multiply"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div className="hidden sm:mb-8 sm:flex sm:justify-center">
              <div className="relative rounded-full px-3 py-1 text-sm text-primary-foreground ring-1 ring-primary-foreground/10 hover:ring-primary-foreground/20">
                Road Rage 2024.{" "}
            ...
            <div className="text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                ...
                <Button variant="link" className="text-primary-foreground hover:text-accent">
